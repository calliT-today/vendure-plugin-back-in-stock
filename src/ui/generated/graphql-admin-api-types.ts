...
export type BackInStock = Node & {
  __typename?: 'BackInStock';
  channel: Channel;
  createdAt: Scalars['DateTime'];
...
export type BackInStockAlreadySubscribedError = ErrorResult & {
  __typename?: 'BackInStockAlreadySubscribedError';
  errorCode: ErrorCode;
  message: Scalars['String'];
};

export type BackInStockFilterParameter = {
  createdAt?: InputMaybe<DateOperators>;
...
export type BackInStockList = PaginatedList & {
  __typename?: 'BackInStockList';
  items: Array<BackInStock>;
  totalItems: Scalars['Int'];
};

export type BackInStockListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<BackInStockFilterParameter>;
  /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>;
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']>;
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<BackInStockSortParameter>;
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']>;
};

export type BackInStockSortParameter = {
  createdAt?: InputMaybe<SortOrder>;
...
export type CreateBackInStockSubscriptionResult = BackInStock | BackInStockAlreadySubscribedError;
...
export enum ErrorCode {
  ...
  BackInStockAlreadySubscribedError = 'BACK_IN_STOCK_ALREADY_SUBSCRIBED_ERROR',
...
export type Mutation = {
  ...
  createBackInStockSubscription: CreateBackInStockSubscriptionResult;
  ...
  updateAsset: Asset;
  updateBackInStockSubscription: BackInStock;
...
export type MutationCreateBackInStockSubscriptionArgs = {
...
export type MutationUpdateBackInStockSubscriptionArgs = {
...
export type Query = {
  ...
  activeBackInStockSubscriptionForProductVariantWithCustomer: BackInStock;
  activeBackInStockSubscriptionsForProductVariant: BackInStockList;
  ...
  assets: AssetList;
  backInStockSubscription?: Maybe<BackInStock>;
...
export type QueryActiveBackInStockSubscriptionForProductVariantWithCustomerArgs = {
  input: CreateBackInStockInput;
};


export type QueryActiveBackInStockSubscriptionsForProductVariantArgs = {
  input?: InputMaybe<ProductVariantInput>;
  options?: InputMaybe<BackInStockListOptions>;
};
...
export type QueryBackInStockSubscriptionArgs = {
  id: Scalars['ID'];
};
...
export type UpdateBackInStockInput = {
  id: Scalars['ID'];
  status: BackInStockSubscriptionStatus;
};
...
export type BackInStockFragment = { __typename?: 'BackInStock', id: string | number, createdAt: Date, updatedAt: Date, status: BackInStockSubscriptionStatus, email: string, productVariant: { __typename?: 'ProductVariant', id: string | number, name: string, stockOnHand: number }, customer?: { __typename?: 'Customer', id: string | number } | null };

export type GetBackInStockSubscriptionListQueryVariables = Exact<{
  options?: InputMaybe<BackInStockListOptions>;
}>;


export type GetBackInStockSubscriptionListQuery = { __typename?: 'Query', backInStockSubscriptions: { __typename?: 'BackInStockList', totalItems: number, items: Array<{ __typename?: 'BackInStock', id: string | number, createdAt: Date, updatedAt: Date, status: BackInStockSubscriptionStatus, email: string, productVariant: { __typename?: 'ProductVariant', id: string | number, name: string, stockOnHand: number }, customer?: { __typename?: 'Customer', id: string | number } | null }> } };
